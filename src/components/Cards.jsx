...
const Cards = ({ mainref }) => {
    ...
    return (
        <section ref={sectionref} className=" rounded-tl-[20px] bg-inherit relative  rounded-tr-[20px] z-[1] pb-[228px]">
            ...
            <motion.a style={position < 1 ? { position: 'sticky', } : { position: 'relative', }} transition={{ duration: 0, type: "tween" }} animate={position < 1 ? '' : viewport} variants={resolVariants2} href="" className="mt-[76px] sticky z-[1] top-[76px] bg-[#fff]  rounded-tl-[20px] py-[20px]  rounded-tr-[20px]  border-t-[1px] border-solid border-transparent border-l-[1px] border-r-[1px] flex bottom-[76px]">
            ...
            <motion.a href="" style={position < 1 ? { position: 'sticky', } : { position: 'relative', }} transition={{ duration: 0, type: "tween" }} animate={position < 1 ? '' : viewport} variants={resolVariants3} className="mt-[150px] sticky z-[1] top-[150px] bg-[#fff]  rounded-tl-[20px] py-[20px]  rounded-tr-[20px]  border-t-[1px] border-solid border-transparent border-l-[1px] border-r-[1px] flex bottom-[0px]">
            ...
            <div ref={thirdDiv} className="min-h-[calc(100vh-228px)] top-[222px] mb-[-250px] sticky bg-inherit flex flex-col  ">
                <div className="flex items-center pt-[40px] pb-[70px] mx-[-20px]">
                    <div className="basis-[37.5%] max-w-[27.5%] px-[20px] flex-grow-0 flex-shrink-0 ml-[4.1666666667%]">
